        ...
        {paginationRange.map((pageNumber, index) => {
          ...
          return (
            <li
              ...
              } p-3 h-[25px] flex-grow text-center my-auto mx-1 flex items-center justify-center rounded-md max-w-[25px]  border-darkGray/20 hover:cursor-pointer md:h-10 md:mx-2 md:w-16 md:max-w-none select-none`}
              key={index}
